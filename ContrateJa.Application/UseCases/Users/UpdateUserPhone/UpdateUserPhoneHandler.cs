...
public sealed class UpdateUserPhoneHandler : IRequestHandler<UpdateUserPhoneCommand>
{
  ...
  public async Task Handle(UpdateUserPhoneCommand command, CancellationToken ct = default)
  {
